...
class ShippingForm(forms.ModelForm):
    ...
    shipping_address1 = forms.CharField(label='', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Bulding Floor Door No'}), required=True)
    ...
    shipping_state = forms.CharField(label='',
                                     ...
                                     required=False)
    shipping_pincode = forms.CharField(label='', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'PinCode'}), required=False)
